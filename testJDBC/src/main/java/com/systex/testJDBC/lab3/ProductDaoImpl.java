...
public class ProductDaoImpl implements ProductDao {
	...
	public Product getProduct(int id) {
		SqlParameterSource nameParameters = new MapSqlParameterSource("productId", id);
		return (Product)this.namedParameterJdbcTemplate
				.queryForObject("select * from product where id=:productId", nameParameters, this.productRowMapper);
	}
